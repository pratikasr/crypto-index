...
// RatesData creates the Rates packet
// data with obi encoded and send it to the channel
func (k msgServer) RatesData(goCtx context.Context, msg *types.MsgRatesData) (*types.MsgRatesDataResponse, error) {
	...
	return &types.MsgRatesDataResponse{}, nil
}

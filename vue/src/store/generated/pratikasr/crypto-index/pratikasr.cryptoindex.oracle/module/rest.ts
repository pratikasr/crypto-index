...
export type OracleMsgRatesDataResponse = object;
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   */
  queryLastRatesId = (params: RequestParams = {}) =>
    this.request<OracleQueryLastRatesIdResponse, RpcStatus>({
      path: `/cryptoindex/oracle/last_rates_id`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   */
  queryRatesResult = (requestId: string, params: RequestParams = {}) =>
    this.request<OracleQueryRatesResponse, RpcStatus>({
      path: `/cryptoindex/oracle/rates_result/${requestId}`,
      method: "GET",
      format: "json",
      ...params,
    });
  ...
  queryParams = (params: RequestParams = {}) =>
    this.request<OracleQueryParamsResponse, RpcStatus>({
      path: `/pratikasr/cryptoindex/oracle/params`,
      method: "GET",
      format: "json",
      ...params,
    });
